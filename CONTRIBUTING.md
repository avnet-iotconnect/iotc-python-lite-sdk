...
- The code repositories should be "editable" from those git repo clones.
...
- Use an advanced editor for Python. 
  While one may prefer Notepad++, vi or emacs, even though your code executes perfectly, 
  using an editor which may not have advanced spell checks, understanding of python 
...
- Check the minimum supported Python version in [pyproject.toml](pyproject.toml).
  and consider testing with that version using pyenv or similar tools.
  Incompatible code changes may be rejected.
